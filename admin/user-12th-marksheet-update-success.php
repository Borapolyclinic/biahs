...
<div class="container mt-5 add-user-success">
    ...
    if (isset($_POST['front'])) {
        ...
        $tempname = $_FILES["student_12th_marksheet"]["tmp_name"];
        $folder = "assets/marksheet/" . $student_12th_marksheet;

        if (empty($student_12th_marksheet)) { ?>
    <div class="alert alert-danger" role="alert">
        Please upload an image or document to update 12th Marksheet.
    </div>
    <?php } else {
    ...
    <p>Success! 12th Marksheet Uploaded.</p>
