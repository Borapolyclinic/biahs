        ...
        <form class="w-100 m-1" method="POST" action="" enctype="multipart/form-data">
            <div class="add-user-form mb-3">
                <div class="w-100 mobile-input m-1">
                    ...
                    <input type="text" class="form-control" name="student_batch" value="<?php echo $student_batch ?>" id="studentName" aria-describedby="emailHelp" disabled>
                </div>
            </div>
            <div class="add-user-form">
                ...
                <div class="add-user-form-row mb-3">
                    <div class="w-100 mobile-input m-1">
                        ...
                        <input type="text" class="form-control" name="student_name" value="<?php echo $student_name ?>" id="studentName" aria-describedby="emailHelp" disabled>
                    </div>
                    <div class="w-100 mobile-input m-1">
                        <label for="studentNumber" class="form-label">Mobile Number</label>
                        <input type="number" class="form-control" name="student_contact" value="<?php echo $student_contact ?>" id="studentNumber" aria-describedby="emailHelp" disabled>
                    </div>
                    <div class="w-100 mobile-input m-1">
                ...
                <div class="add-user-form-row mb-3">
                    <div class="w-100 mobile-input m-1">
                        ...
                        <input type="text" class="form-control" value="<?php echo $student_roll ?>" name="student_roll" id="studentName" aria-describedby="emailHelp" disabled>
                    </div>
                    <?php
                ...
                <div class="add-user-form-row mb-3">
                    <div class="w-100 mobile-input m-1">
                        ...
                        <select class="form-select" name="student_category" aria-label="Default select example" disabled>
                            <?php
                    ...
                    <div class="w-100 mobile-input m-1">
                        ...
                        <select class="form-select" name="student_admission_mode" aria-label="Default select example" disabled>
                            <?php
                            $fetch_name = "SELECT * FROM `bora_student` WHERE `student_id` = '$student_id'";
                            $fetch_name_res = mysqli_query($connection, $fetch_name);
                            $student_admission_mode = "";
            ...
            <div class="add-user-form mt-3">
                <div class="add-user-form-row mb-3">
                    <div class="w-100 mobile-input m-1">
                        ...
                        <input disabled type="text" class="form-control" name="student_father" value="<?php echo $student_father ?>" id="fathersName" aria-describedby="emailHelp">
                    </div>
                    <div class="w-100 mobile-input m-1">
                        <label for="mothersName" class="form-label">Mother's Name</label>
                        <input disabled type="text" class="form-control" name="student_mother" id="mothersName" value="<?php echo $student_mother ?>" aria-describedby="emailHelp">
                    </div>
                    <div class="w-100 mobile-input m-1">
                        <label for="mothersName" class="form-label">Father's Contact Number</label>
                        <input disabled type="text" class="form-control" name="student_father_contact" id="mothersName" value="<?php echo $student_father_contact ?>" aria-describedby="emailHelp">
                    </div>
                </div>
                ...
                <div class="add-user-form-row mb-3">
                    <div class="w-100 mobile-input m-1">
                        ...
                        <input disabled type="text" class="form-control" name="student_guardian_name" value="<?php echo $student_guardian_name ?>" id="fathersName" aria-describedby="emailHelp">
                    </div>
                    <div class="w-100 mobile-input m-1">
                        <label for="fathersName" class="form-label">Guardian's Contact No.</label>
                        <input disabled type="text" class="form-control" name="student_guardian_contact" value="<?php echo $student_guardian_contact ?>" id="fathersName" aria-describedby="emailHelp">
                    </div>
                    <div class="w-100 mobile-input m-1">
                        <label for="fathersName" class="form-label">Contact No. (Optional)</label>
                        <input disabled type="text" class="form-control" name="student_guardian_contact_2" value="<?php echo $student_guardian_contact_2 ?>" id="fathersName" aria-describedby="emailHelp">
                    </div>
                    <div class="w-100 mobile-input m-1">
                        <label for="mothersName" class="form-label">Relation</label>
                        <select class="form-select" name="student_guardian_relation" aria-label="Default select example" disabled>
            ...
            <div class="add-user-form mt-3">
                <div class="mb-3 w-100">
                    <div class="col-md-4 mobile-input m-1">
                        ...
                        <input disabled type="number" class="form-control w-100" value="<?php echo $student_aadhar_number  ?>" name="student_aadhar_number" id="fathersName" aria-describedby="emailHelp">
                    </div>
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Address (as on Aadhar Card)*</label>
                    <input disabled style="height: 100px" type="text" class="form-control" name="student_aadhar_address" id="mothersName" value="<?php echo $student_aadhar_address ?>" aria-describedby="emailHelp">
                </div>
                ...
                <div class="mb-3" id="communicationAddress">
                    ...
                    <input disabled style="height: 100px" type="text" class="form-control" name="student_comm_address" id="mothersName" value="<?php echo $student_comm_address ?>" aria-describedby="emailHelp">
                </div>
